...
class XmlLines(models.Model):
    ...
    def generar_xml(self):
        ...
        for item in self.line_id:
            ...
            elemento_hijo_2 = ET.SubElement(elemento_hijo_1, 'rif_retenido').text=str(item.rif_retenido)
            elemento_hijo_3 = ET.SubElement(elemento_hijo_1, 'numero_factura').text=str(item.numero_factura) if item.numero_factura else '0'
            elemento_hijo_4 = ET.SubElement(elemento_hijo_1, 'numero_control').text=str(item.numero_control) if  item.numero_control else 'NA'
            elemento_hijo_5 = ET.SubElement(elemento_hijo_1, 'fecha_operacion').text=str(fecha)
            elemento_hijo_6 = ET.SubElement(elemento_hijo_1, 'codigo_concepto').text=str(item.codigo_concepto)
            elemento_hijo_7 = ET.SubElement(elemento_hijo_1, 'monto_operacion').text=str(item.monto_operacion)
            elemento_hijo_8 = ET.SubElement(elemento_hijo_1, 'porcentaje_retencion').text=str(item.porcentaje_retencion)
